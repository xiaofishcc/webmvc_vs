...
// MFCApplication1jiyuduihuakuang.cpp : 定义应用程序的类行为。
//
...
BEGIN_MESSAGE_MAP(CMFCApplication1jiyuduihuakuangApp, CWinApp)
...
BOOL CMFCApplication1jiyuduihuakuangApp::InitInstance()
{
	...
	CMFCApplication1jiyuduihuakuangDlg dlg;
	m_pMainWnd = &dlg;
